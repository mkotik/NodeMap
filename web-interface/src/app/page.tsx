    ...
    <div className="new-chat">
      ...
      <div className="new-chat__input-container">
        ...
        <div className="new-chat__input-toolbar">
          <div className="new-chat__toolbar-actions">
            <button
              className="new-chat__toolbar-btn"
              type="button"
      ...
      <div className="new-chat__suggestions">
        {suggestions.map((suggestion) => (
          ...
          >
            <div
              className={`new-chat__suggestion-dot new-chat__suggestion-dot--${suggestion.color}`}
            />
            <div className="new-chat__suggestion-text">
              <span className="new-chat__suggestion-title">
                {suggestion.title}
              </span>
              <span className="new-chat__suggestion-desc">
